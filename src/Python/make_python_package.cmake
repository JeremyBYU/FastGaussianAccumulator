...
file(MAKE_DIRECTORY ${PYTHON_PACKAGE_DST_DIR}/fastgac)
...
file(COPY ${PYTHON_COMPILED_MODULE_PATH}
     DESTINATION ${PYTHON_PACKAGE_DST_DIR}/fastgac)
...
configure_file("${PYTHON_PACKAGE_SRC_DIR}/fastgac/__init__.py"
               "${PYTHON_PACKAGE_DST_DIR}/fastgac/__init__.py")
