...
PYBIND11_MODULE(fastga, m)
{
    ...
    py::class_<FastGA::GaussianAccumulator<uint32_t>>(m, "GaussianAccumulatorUI32")
        ...
        .def("get_bucket_normals", &FastGA::GaussianAccumulator<uint32_t>::GetBucketNormals, "mesh_order"_a = false)
        .def("get_normalized_bucket_counts", &FastGA::GaussianAccumulator<uint32_t>::GetNormalizedBucketCounts, "mesh_order"_a = false)
        .def("get_normalized_bucket_counts_by_vertex", &FastGA::GaussianAccumulator<uint32_t>::GetNormalizedBucketCountsByVertex, "mesh_order"_a = false)
        ...
        .def("copy_ico_mesh", &FastGA::GaussianAccumulator<uint32_t>::CopyIcoMesh, "mesh_order"_a = false);
    ...
    py::class_<FastGA::GaussianAccumulator<uint64_t>>(m, "GaussianAccumulatorUI64")
        ...
        .def("get_bucket_normals", &FastGA::GaussianAccumulator<uint64_t>::GetBucketNormals, "mesh_order"_a = false)
        .def("get_normalized_bucket_counts", &FastGA::GaussianAccumulator<uint64_t>::GetNormalizedBucketCounts, "mesh_order"_a = false)
        .def("get_normalized_bucket_counts_by_vertex", &FastGA::GaussianAccumulator<uint64_t>::GetNormalizedBucketCountsByVertex, "mesh_order"_a = false)
        ...
        .def("copy_ico_mesh", &FastGA::GaussianAccumulator<uint64_t>::CopyIcoMesh, "mesh_order"_a = false);
