...
setup(
    ...
    description="Fast Gaussian Accumualtor. Detect dominant plane normals by integrating normals on a sphere.",
    url='https://github.com/JeremyBYU/FastGaussianAccumulator',
