...
file(MAKE_DIRECTORY ${PYTHON_PACKAGE_DST_DIR}/fastga)
...
file(COPY ${PYTHON_COMPILED_MODULE_PATH}
     DESTINATION ${PYTHON_PACKAGE_DST_DIR}/fastga)
...
configure_file("${PYTHON_PACKAGE_SRC_DIR}/fastga/__init__.py"
               "${PYTHON_PACKAGE_DST_DIR}/fastga/__init__.py")
